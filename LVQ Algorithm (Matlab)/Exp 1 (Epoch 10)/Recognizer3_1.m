...
data = xlsread('C:\Users\user\Desktop\SEM 8\Project Sarjana Muda (PSM)\THESIS PROGRESS\Control Chart Pattern Recognition (CCPR) Project\LVQ Algorithm (Matlab)\Exp 1 (Epoch 10)\Input_Data_1.csv');
